...
#COOLING_FCHAN = clock1.cooling_fchan() + clock2.cooling_fchan()+ minus1.cooling_fchan() + plus1.cooling_fchan() + minus2.cooling_fchan() + plus2.cooling_fchan() # + clock1.cooling_fchan() + clock2.cooling_fchan() 
