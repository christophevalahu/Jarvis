...
def statedetone_pmt(dark_data, bright_data, cmd_params) :
    ...
    parameters_bright, cov_matrix_bright = curve_fit(poisson, bin_middles_bright, entries_bright)
...
def statedettwo_pmt(dark_data, one_bright_data, two_bright_data, cmd_params) :
    ...
    #Fit poisson curve to bright and dark histogram
    parameters_dark, cov_matrix_dark = curve_fit(poisson, bin_middles_dark, entries_dark)
    parameters_one_bright, cov_matrix_one_bright = curve_fit(poisson, bin_middles_one_bright, entries_one_bright)
    parameters_two_bright, cov_matrix_two_bright = curve_fit(poisson, bin_middles_two_bright, entries_two_bright)
